from .historial_clinico_view import HistorialClinicoPorMascotaView
from .consulta_clinica_view import (
    ConsultaClinicaListCreateView,
    ConsultaClinicaDetailView,
)
from .tratamiento_view import (
    TratamientoListCreateView,
    TratamientoDetailView,
)
from .receta_view import (
    RecetaPorConsultaView,
    RecetaDetailView,
)
from .detalle_receta_view import (
    DetalleRecetaListCreateView,
    DetalleRecetaDetailView,
)
from .vacuna_aplicada_view import (
    VacunaAplicadaListCreateView,
    VacunaAplicadaDetailView,
)
from .archivo_clinico_view import (
